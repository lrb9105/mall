    ...
    <div class="card sidebar-menu mb-4">
        ...
        <div class="card-body">
            <ul class="nav nav-pills flex-column category-menu" id="category-menu">
                <li><a href="#" data-toggle="collapse" data-target="#collapse0" class="nav-link top">상의 <span class="badge badge-secondary">6</span></a>
                ...
                <li><a href="#" data-toggle="collapse" data-target="#collapse2" class="nav-link bottom">바지  <span class="badge badge-secondary">0</span></a>
                ...
                <li><a href="#" data-toggle="collapse" data-target="#collapse3" class="nav-link bottom">신발  <span class="badge badge-secondary">0</span></a>
                ...
                <li><a href="#" data-toggle="collapse" data-target="#collapse4" class="nav-link bottom">모자  <span class="badge badge-secondary">0</span></a>
