                                        ...
                                        <tr>
                                            <td bgcolor=white>
                                                <table class="table">
                                                    ...
                                                    <tr>
                                                        <td class="item_title" colspan="6">모델 정보<span>&nbsp;&nbsp;&nbsp;&nbsp;<button type="button" id="model_info_add" class="btn btn-dark">모델정보 추가</button></span></td>
                                                    </tr>
                                                    <tr id="tr_model_info">
                                                        ...
                                                        <td>
                                                            <select class="form-control"  name="model_size[]" id="product_size">'
                                                                <option value="">[선택]</option>
                                                                <option value="S">S</option>
                                                                <option value="M">M</option>
                                                                <option value="L">L</option>
    ...
    *** COPYRIGHT ***
    ...
    ?>
        <script>
            ...
            $('#product_info_add').on("click", function(){
              ...
              /* let tr = '<tr>'
                           ...
                           + '<td>'
                                + '<select class="form-control"  name="product_color" id="product_color">'
                                    + '<option value="">[선택]</option>'
                                    + '<option id="product_color_etc" value="etc">직접입력</option>'
                                + '</select>'
                                + '<input class="form-control" id="product_color_input" placeholder="색상을 입력하세요(ex 화이트, 블랙, 레드, 그린).">'
                           + '</td>'
                           + '<td class="item_title">사이즈</td>'
                           + '<td>'
                                + '<select class="form-control"  name="product_size" id="product_size">'
                                    + '<option value="">[선택]</option>'
                                    + '<option id="product_size_etc" value="etc">직접입력</option>'
                                + '</select>'
                                + '<input class="form-control" id="product_size_input" placeholder="사이즈를 입력하세요.">'
                           + '</td>'
                           + '<td class="item_title">수량</td>'
                           + '<td>'
                                + '<input class="form-control " type="number" name="product_material" id="product_material">'
                           + '</td>'
                        + '</tr>';*/
            ...
            // 2차 카테고리 선택 시 1차카테고리에 따라 속성값 추가하기
            $('#second_category').change(function(){
               if($(this).val() != ''){
                   ...
                   } else if($('#first_category').val() == '27'){ //신발
                        // 사이즈 신발 mm로 변경해주기
                   } else if($('#first_category').val() == '28'){ //모자
                       tr =  '<tr>'
                           + '<td class="item_title added_info">치수정보</td>'
                           + '<td colspan="5" class="added_info">'
                           + '<table class="table" style="border: 1px solid black">'
